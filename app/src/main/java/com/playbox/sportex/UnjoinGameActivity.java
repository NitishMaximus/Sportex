...
public class UnjoinGameActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_unjoin_game);
            ...
            public void onClick(View v) {
                table_games.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        dataSnapshot.child(key).child("Going").child(PreferenceUtils.getName(getApplicationContext())).getRef().removeValue();
                    }
                ...
                startActivity(new Intent(UnjoinGameActivity.this, DashboardActivity.class));
            }
        });
