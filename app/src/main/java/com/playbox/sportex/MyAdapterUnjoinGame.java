...
public class MyAdapterUnjoinGame extends RecyclerView.Adapter<MyAdapter.MyViewHolder> {
    ...
    public MyAdapterUnjoinGame(ArrayList<Games> gameList, ArrayList<String> keyList, Context context) {
    ...
    public void onBindViewHolder(MyAdapter.MyViewHolder holder, int position) {
        ...
        holder.gamecard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(context, UnjoinGameActivity.class);
                i.putExtra("Key", key);
