...
public class MyAdapterRemoveGame extends RecyclerView.Adapter<MyAdapter.MyViewHolder> {
    private List<Games> gameList;
    private List<String> keyList;
    private Context context;
    FirebaseDatabase database = FirebaseDatabase.getInstance();
    final DatabaseReference table_games = database.getReference();
    ...
    public MyAdapterRemoveGame(ArrayList<Games> gameList, ArrayList<String> keyList, Context context) {
    ...
    public void onBindViewHolder(MyAdapter.MyViewHolder holder, int position) {
        ...
        holder.gamecard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(context, RemoveGameActivity.class);
                i.putExtra("Key", key);
